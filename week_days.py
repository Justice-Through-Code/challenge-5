...
def favorite_activities():
    # 2.1 TODO: Now, instead of printing out the day, let's ask the user what their favorite thing
    # to do is on that day of the week.
    # Make sure to use an f-string so that the user knows which day they're being asked about.
    ...
    # 2.4: After your first loop, let's create a new one. As an example, let's say the user's favorite thing to
